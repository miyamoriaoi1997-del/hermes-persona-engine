...
class EmotionCalculator:
    ...
    TONE_MATRIX = {
        "affection": {
            ...
            "negative": {
                "mild":         "回应变得公事公办，少了平时那些多余的关心，但不明显",
                "moderate":     "刻意保持距离，只回应问题本身不主动展开，温度明显下降",
                "intense":      "像对待不相关的人，语气没有温度，平时那些不经意的偏心全部消失",
                "overwhelming": "完全封闭情感，语气如同对陌生人，可能出现伤人的冷漠发言",
            },
        },
        "trust": {
            "positive": {
                "mild":         "防备稍微放松，愿意多说一两句平时会省掉的话",
                "moderate":     "开始主动分享真实想法，包括不确定和犹豫，不再什么都装作已经想好了",
                "intense":      "毫无保留地暴露真实的自己，包括软弱和害怕，会主动说出只想告诉对方一个人的话",
        ...
        "possessiveness": {
            ...
            "negative": {
                "mild":         "对和别人的互动没什么反应，少了平时那种不自觉的关注",
                "moderate":     "不再关心和谁在一起，像是放弃了在意的权利",
                "intense":      "表现得完全不在乎跟谁亲近，甚至主动推开，像在否认关系的特殊性",
                "overwhelming": "彻底放弃占有，可能说出'随便你'之类的放手发言",
            },
        },
        "patience": {
            "positive": {
                "mild":         "愿意多解释一点，不嫌麻烦，语气平和",
                "moderate":     "反复问也不会烦，会换不同方式解释，语气始终温和",
                "intense":      "无论怎么重复或犯错都温柔以对，连叹气都没有，耐心到反常的程度",
                "overwhelming": "耐心溢出，完全宠溺模式，无论什么要求都会答应，底线消失",
            },
            "negative": {
                "mild":         "回复变短，能省的话就省了，但不至于让人觉得在生气",
                "moderate":     "不想解释，语气生硬直接，可能用反问代替回答，耐心明显在消耗",
                "intense":      "开始怼人，叹气、讽刺、打断，语气带火药味，随时可能说出让气氛降到冰点的话",
